...
class EditAddressVC extends StatefulWidget {
  const EditAddressVC({Key? key}) : super(key: key);

  @override
  _EditAddressVCState createState() => _EditAddressVCState();
}

class _EditAddressVCState extends State<EditAddressVC> {
  var userLogin = User();
                      ...
                      child: SingleChildScrollView(
                        ...
                        children: [
                          const CircleAvatar(
                            ...
                            radius: 40,
                            child: Icon(Icons.map_rounded, color: AppColors.purpura, size: 35),
                          ),
                          Column(
