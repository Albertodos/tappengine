...
class EditEmailVC extends StatefulWidget {
  const EditEmailVC({Key? key}) : super(key: key);

  @override
  _EditEmailVCState createState() => _EditEmailVCState();
}

class _EditEmailVCState extends State<EditEmailVC> {
  var userLogin = User();
                      ...
                      child: SingleChildScrollView(
                        ...
                        children: [
                          const CircleAvatar(
                            ...
                            radius: 40,
                            child: Icon(Icons.email_rounded, color: AppColors.purpura, size: 35),
                          ),
                          Column(
