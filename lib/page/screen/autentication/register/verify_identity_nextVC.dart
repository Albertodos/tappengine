...
import 'verify_identity_infoVC.dart';

class VerifyIdentityNextVC extends StatefulWidget {
  const VerifyIdentityNextVC({Key? key}) : super(key: key);

  @override
  State<VerifyIdentityNextVC> createState() => _VerifyIdentityNextVCState();
}

class _VerifyIdentityNextVCState extends State<VerifyIdentityNextVC> {
  bool selected = false;
                        ...
                        child: UIBottons(
                            ...
                            cb: (v) {
                              ...
                              Future.delayed(const Duration(milliseconds: 800), () {
                                Get.offAll(const VerifyIdentityInfoVC());
                              });
                            })),
