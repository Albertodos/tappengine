...
class AllEventsVC extends StatefulWidget {
  const AllEventsVC({super.key});

  @override
  State<AllEventsVC> createState() => _AllEventsVCState();
}

class _AllEventsVCState extends State<AllEventsVC> {
  @override
