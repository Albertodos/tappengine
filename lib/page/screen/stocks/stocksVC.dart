...
class StrocksVC extends StatefulWidget {
  const StrocksVC({super.key});

  @override
  State<StrocksVC> createState() => _StrocksVCState();
}

class _StrocksVCState extends State<StrocksVC> {
  @override
